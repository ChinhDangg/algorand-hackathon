...
def test_says_hello(voting_app_client: VotingAppClient) -> None:
    result = voting_app_client.send.hello(args=("World",))
    assert result.abi_return == "Hello, World"


def test_simulate_says_hello_with_correct_budget_consumed(
    voting_app_client: VotingAppClient,
) -> None:
    result = (
        voting_app_client.new_group()
        .hello(args=("World",))
        .hello(args=("Jane",))
        .simulate()
    )
